...
#endif
static const char *ng0 = "H:/BUAA_workshop/verilog/CPU-pipline/ALU.v";
...
LAB163:    t451 = *((unsigned int *)t417);
    t452 = (~(t451));
    t453 = *((unsigned int *)t442);
    t454 = (t452 || t453);
    if (t454 > 0)
        goto LAB164;
...
LAB162:    t447 = (t0 + 1208U);
    t448 = *((char **)t447);
    t447 = (t0 + 1528U);
    t449 = *((char **)t447);
    memset(t450, 0, 8);
    xsi_vlog_unsigned_arith_rshift(t450, 32, t448, 32, t449, 5);
    goto LAB163;

LAB164:    t447 = (t0 + 1368U);
    t457 = *((char **)t447);
    t447 = ((char*)((ng10)));
    memset(t458, 0, 8);
    t459 = (t457 + 4);
...
LAB172:    *((unsigned int *)t458) = 1;

LAB174:    memset(t456, 0, 8);
    t474 = (t458 + 4);
...
LAB182:    if (*((unsigned int *)t481) > 0)
        goto LAB183;

LAB184:    if (*((unsigned int *)t456) > 0)
        goto LAB185;

LAB186:    memcpy(t455, t492, 8);

LAB187:    goto LAB165;

LAB166:    xsi_vlog_unsigned_bit_combine(t416, 32, t450, 32, t455, 32);
    goto LAB170;

LAB168:    memcpy(t416, t450, 8);
    goto LAB170;
...
LAB179:    t485 = (t0 + 1208U);
    t486 = *((char **)t485);
    t485 = ((char*)((ng11)));
    memset(t487, 0, 8);
    xsi_vlog_unsigned_lshift(t487, 32, t486, 32, t485, 32);
    goto LAB180;

LAB181:    t494 = (t0 + 1368U);
    t495 = *((char **)t494);
    t494 = ((char*)((ng12)));
    memset(t496, 0, 8);
    t497 = (t495 + 4);
...
LAB189:    *((unsigned int *)t496) = 1;

LAB191:    memset(t493, 0, 8);
    t512 = (t496 + 4);
...
LAB199:    if (*((unsigned int *)t519) > 0)
        goto LAB200;

LAB201:    if (*((unsigned int *)t493) > 0)
        goto LAB202;

LAB203:    memcpy(t492, t535, 8);

LAB204:    goto LAB182;

LAB183:    xsi_vlog_unsigned_bit_combine(t455, 32, t487, 32, t492, 32);
    goto LAB187;

LAB185:    memcpy(t455, t487, 8);
    goto LAB187;
...
LAB209:    if (*((unsigned int *)t525) < *((unsigned int *)t526))
        goto LAB207;

LAB208:    t530 = ((char*)((ng1)));
    xsi_vlogtype_concat(t523, 32, 32, 2U, t530, 31, t527, 1);
    goto LAB197;

LAB198:    t537 = (t0 + 1368U);
    t538 = *((char **)t537);
    t537 = ((char*)((ng13)));
    memset(t539, 0, 8);
    t540 = (t538 + 4);
...
LAB211:    *((unsigned int *)t539) = 1;

LAB213:    memset(t536, 0, 8);
    t555 = (t539 + 4);
    t556 = *((unsigned int *)t555);
    t557 = (~(t556));
    t558 = *((unsigned int *)t539);
    t559 = (t558 & t557);
    t560 = (t559 & 1U);
    if (t560 != 0)
        goto LAB214;

LAB215:    if (*((unsigned int *)t555) != 0)
        goto LAB216;

LAB217:    t562 = (t536 + 4);
    t563 = *((unsigned int *)t536);
    t564 = *((unsigned int *)t562);
    t565 = (t563 || t564);
    if (t565 > 0)
        goto LAB218;

LAB219:    t574 = *((unsigned int *)t536);
    t575 = (~(t574));
...
LAB221:    if (*((unsigned int *)t562) > 0)
        goto LAB222;

LAB223:    if (*((unsigned int *)t536) > 0)
        goto LAB224;

LAB225:    memcpy(t535, t578, 8);

LAB226:    goto LAB199;

LAB200:    xsi_vlog_unsigned_bit_combine(t492, 32, t523, 32, t535, 32);
    goto LAB204;

LAB202:    memcpy(t492, t523, 8);
    goto LAB204;
...
LAB231:    if (*((unsigned int *)t568) > *((unsigned int *)t569))
        goto LAB229;

LAB230:    t573 = ((char*)((ng1)));
    xsi_vlogtype_concat(t566, 32, 32, 2U, t573, 31, t570, 1);
    goto LAB219;

LAB220:    t578 = ((char*)((ng1)));
    goto LAB221;

LAB222:    xsi_vlog_unsigned_bit_combine(t535, 32, t566, 32, t578, 32);
    goto LAB226;

LAB224:    memcpy(t535, t566, 8);
    goto LAB226;
...
extern void work_m_00000000000229009565_0886308060_init()
{
	static char *pe[] = {(void *)Cont_12_0,(void *)Cont_26_1};
	xsi_register_didat("work_m_00000000000229009565_0886308060", "isim/mips_tb_isim_beh.exe.sim/work/m_00000000000229009565_0886308060.didat");
