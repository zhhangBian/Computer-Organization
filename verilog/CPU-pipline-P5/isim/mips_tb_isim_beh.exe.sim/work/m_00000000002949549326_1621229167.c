...
#endif
static const char *ng0 = "H:/BUAA_workshop/verilog/CPU-pipline/GRF.v";
static int ng1[] = {0, 0};
static int ng2[] = {1, 0};
static int ng3[] = {32, 0};
...
LAB44:    xsi_set_current_line(32, ng0);
    ...
    t3 = (t0 + 2008U);
    t7 = *((char **)t3);
    xsi_vlogfile_write(1, 0, 0, ng5, 5, t0, (char)118, t101, 64, (char)118, t4, 32, (char)118, t5, 5, (char)118, t7, 32);
    goto LAB41;
