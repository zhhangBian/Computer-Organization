...
#endif
static const char *ng0 = "H:/BUAA_workshop/Computer Organization/verilog/CPU-pipline-P7/ALU.v";
...
LAB20:    t580 = (t0 + 6640);
    ...
    t584 = *((char **)t583);
    memcpy(t584, t3, 8);
    xsi_driver_vfirst_trans(t580, 0, 31);
    t585 = (t0 + 6432);
    *((int *)t585) = 1;
...
LAB162:    t448 = (t0 + 1208U);
    ...
    t451 = *((char **)t448);
    memset(t452, 0, 8);
    xsi_vlog_signed_arith_rshift(t452, 32, t449, 32, t451, 32);
    goto LAB163;
...
LAB172:    *((unsigned int *)t460) = 1;

LAB174:    memset(t458, 0, 8);
    t476 = (t460 + 4);
...
LAB182:    if (*((unsigned int *)t483) > 0)
        goto LAB183;

LAB184:    if (*((unsigned int *)t458) > 0)
        goto LAB185;

LAB186:    memcpy(t457, t494, 8);

LAB187:    goto LAB165;

LAB166:    xsi_vlog_unsigned_bit_combine(t416, 32, t452, 32, t457, 32);
    goto LAB170;

LAB168:    memcpy(t416, t452, 8);
    goto LAB170;
...
LAB179:    t487 = (t0 + 1208U);
    t488 = *((char **)t487);
    t487 = ((char*)((ng11)));
    memset(t489, 0, 8);
    xsi_vlog_unsigned_lshift(t489, 32, t488, 32, t487, 32);
    goto LAB180;

LAB181:    t496 = (t0 + 1368U);
    t497 = *((char **)t496);
    t496 = ((char*)((ng12)));
    memset(t498, 0, 8);
    t499 = (t497 + 4);
...
LAB197:    t532 = *((unsigned int *)t495);
    t533 = (~(t532));
    t534 = *((unsigned int *)t521);
    t535 = (t533 || t534);
    if (t535 > 0)
        goto LAB198;

LAB199:    if (*((unsigned int *)t521) > 0)
        goto LAB200;

LAB201:    if (*((unsigned int *)t495) > 0)
        goto LAB202;

LAB203:    memcpy(t494, t536, 8);

LAB204:    goto LAB182;

LAB183:    xsi_vlog_unsigned_bit_combine(t457, 32, t489, 32, t494, 32);
    goto LAB187;

LAB185:    memcpy(t457, t489, 8);
    goto LAB187;
...
LAB196:    t527 = (t0 + 1048U);
    t528 = *((char **)t527);
    t527 = (t0 + 1208U);
    t530 = *((char **)t527);
    memset(t531, 0, 8);
    xsi_vlog_signed_less(t531, 32, t528, 32, t530, 32);
    t527 = ((char*)((ng1)));
    xsi_vlogtype_concat(t525, 32, 32, 2U, t527, 31, t531, 1);
    goto LAB197;

LAB198:    t538 = (t0 + 1368U);
    t539 = *((char **)t538);
    t538 = ((char*)((ng13)));
    memset(t540, 0, 8);
    t541 = (t539 + 4);
...
LAB206:    *((unsigned int *)t540) = 1;

LAB208:    memset(t537, 0, 8);
    t556 = (t540 + 4);
...
LAB210:    if (*((unsigned int *)t556) != 0)
        goto LAB211;

LAB212:    t563 = (t537 + 4);
    t564 = *((unsigned int *)t537);
    t565 = *((unsigned int *)t563);
    t566 = (t564 || t565);
    if (t566 > 0)
        goto LAB213;

LAB214:    t575 = *((unsigned int *)t537);
    t576 = (~(t575));
...
LAB216:    if (*((unsigned int *)t563) > 0)
        goto LAB217;

LAB218:    if (*((unsigned int *)t537) > 0)
        goto LAB219;

LAB220:    memcpy(t536, t579, 8);

LAB221:    goto LAB199;

LAB200:    xsi_vlog_unsigned_bit_combine(t494, 32, t525, 32, t536, 32);
    goto LAB204;

LAB202:    memcpy(t494, t525, 8);
    goto LAB204;
...
LAB226:    if (*((unsigned int *)t569) < *((unsigned int *)t570))
        goto LAB224;

LAB225:    t574 = ((char*)((ng1)));
    xsi_vlogtype_concat(t567, 32, 32, 2U, t574, 31, t571, 1);
    goto LAB214;

LAB215:    t579 = ((char*)((ng1)));
    goto LAB216;

LAB217:    xsi_vlog_unsigned_bit_combine(t536, 32, t567, 32, t579, 32);
    goto LAB221;

LAB219:    memcpy(t536, t567, 8);
    goto LAB221;
...
static void NetDecl_36_7(char *t0)
{
    char t4[8];
    char t22[8];
    char t33[8];
...
extern void work_m_00000000002947137522_0886308060_init()
{
	static char *pe[] = {(void *)Cont_13_0,(void *)Cont_27_1,(void *)NetDecl_29_2,(void *)NetDecl_30_3,(void *)NetDecl_32_4,(void *)NetDecl_33_5,(void *)NetDecl_35_6,(void *)NetDecl_36_7,(void *)Cont_37_8};
	xsi_register_didat("work_m_00000000002947137522_0886308060", "isim/mips_txt_isim_beh.exe.sim/work/m_00000000002947137522_0886308060.didat");
