...
#endif
static const char *ng0 = "H:/BUAA_workshop/Computer Organization/verilog/CPU-pipline-P7/Ereg.v";
static int ng1[] = {1, 0};
...
LAB57:    if (*((unsigned int *)t172) > 0)
        goto LAB58;

LAB59:    if (*((unsigned int *)t163) > 0)
        goto LAB60;

LAB61:    memcpy(t162, t181, 8);

LAB62:    t201 = (t0 + 3208);
    xsi_vlogvar_wait_assign_value(t201, t162, 0, 0, 32, 0LL);
...
LAB72:    if (*((unsigned int *)t182) > 0)
        goto LAB73;

LAB74:    memcpy(t181, t195, 8);

LAB75:    goto LAB57;

LAB58:    xsi_vlog_unsigned_bit_combine(t162, 32, t176, 32, t181, 32);
    goto LAB62;

LAB60:    memcpy(t162, t176, 8);
    goto LAB62;
...
LAB71:    xsi_vlog_unsigned_bit_combine(t181, 32, t196, 32, t195, 32);
    goto LAB75;

LAB73:    memcpy(t181, t196, 8);
    goto LAB75;
...
LAB84:    xsi_vlog_unsigned_bit_combine(t6, 32, t37, 32, t7, 32);
    goto LAB88;

LAB86:    memcpy(t6, t37, 8);
    goto LAB88;
...
LAB97:    xsi_vlog_unsigned_bit_combine(t6, 32, t37, 32, t7, 32);
    goto LAB101;

LAB99:    memcpy(t6, t37, 8);
    goto LAB101;

}


extern void work_m_00000000003091146040_3212961919_init()
{
	static char *pe[] = {(void *)Always_28_0};
	xsi_register_didat("work_m_00000000003091146040_3212961919", "isim/mips_txt_isim_beh.exe.sim/work/m_00000000003091146040_3212961919.didat");
